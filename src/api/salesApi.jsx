...
import {
  fetchMonthlyRevenueMock,
  fetchItemQtyMonthlyByYmMock,
  fetchItemQtyMonthlyAllMock,
} from "../mock/salesMock";

export async function fetchMonthlyRevenue() {
  return fetchMonthlyRevenueMock();
}

export async function fetchItemQtyMonthlyByYm(ym) {
  return fetchItemQtyMonthlyByYmMock(ym);
}

export async function fetchItemQtyMonthlyAll() {
  return fetchItemQtyMonthlyAllMock();
}
